...
*/ var r =
  ...
  function(e, t, n) {
    ...
    var ol = {
      ...
      enqueueForceUpdate: function(e, t) {
        ...
        var n = wa(),
          r = Yi((n = Yo(n, e)));
        (r.tag = Hi), null != t && (r.callback = t), Bo(), Gi(e, r), Zo(e, n);
      },
    };
    ...
    function Ni(e, t, n, r, l, i) {
      ...
      return (
        (t.effectTag |= 1),
        null !== e && o
          ? ((t.child = hl(t, e.child, null, i)), (t.child = hl(t, null, a, i)))
          : wi(e, t, a, i),
    ...
    function ho(e) {
      switch (('function' == typeof Vr && Vr(e), e.tag)) {
        ...
        case 1:
          if (
            (po(e), 'function' == typeof (t = e.stateNode).componentWillUnmount)
          ) {
            try {
    ...
    var _o = He.ReactCurrentDispatcher,
    ...
    function Ho(e, t) {
      ...
      for (
        Ln(yr), yr = null, _n = !!hr, hr = null, e.current = t, Mo = r;
        null !== Mo;
    ...
    function Ko(e, t) {
      ...
      for (var l = !1; ; ) {
        try {
          ...
          if (((Fi = Di = Ui = null), Gl(), null === Po)) (l = !0), za(t);
          else {
            null === Po && o('271');
            var i = Po,
              a = i.return;
      ...
      if (((Co = !1), (_o.current = n), (Fi = Di = Ui = null), Gl(), l)) {
    ...
    function qo(e, t) {
      ...
      3 === e.tag &&
        (Gi(e, (n = xo(e, (n = lo(t, e)), 1073741823))), Zo(e, 1073741823));
    }
    function Yo(e, t) {
    ...
    function wa() {
      return la ? ha : (_a(), (0 !== oa && 1 !== oa) || (ba(), (ha = ma)), ha);
    }
    function Ta(e, t) {
    ...
    function Pa(e, t) {
      if ((_a(), t)) {
        for (
          ba(), ha = ma;
          null !== ia && 0 !== oa && e <= oa && !(Sa && ma > oa);

        )
          {Oa(ia, oa, ma > oa), _a(), ba(), (ha = ma);}}
      } else for (; null !== ia && 0 !== oa && e <= oa; ) Oa(ia, oa, !1), _a();
      if (
        (t && ((na = 0), (ra = null)),
        0 !== oa && ka(ia, oa),
        (va = 0),
  ...
  function(e, t, n) {
        ...
        (i = [
          {
            ...
            value: function() {
              return l.a.createElement(
                'div',
                null,
                l.a.createElement('h1', null, ' My React App!! '),
              );
            },
          },
        ]) && u(n.prototype, i),
    ...
    o.a.render(l.a.createElement(d, null), document.getElementById('app'));
  },
]);
